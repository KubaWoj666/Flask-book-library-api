...
def test_registration_invalid_data(client, data, missing_fields):
    response = client.post('/api/v1/auth/register',
                           json=data)
    ...
    assert 'token' is not response_data
...
def test_registration_invalid_already_used_username(client, user):
    response = client.post('/api/v1/auth/register',
                           json={
...
def test_registration_invalid_already_used_email(client, user):
    response = client.post('/api/v1/auth/register',
                           json={
                               'username': "new user",
                               "password": '123456',
